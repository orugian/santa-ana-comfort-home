...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed z-[1000] right-4 bottom-4 md:right-6 md:bottom-6">
      {/* Toggle Button */}
      <button
        aria-label="Abrir WhatsApp"
        onClick={() => setOpen((v) => !v)}
        className="w-14 h-14 md:w-16 md:h-16 rounded-full shadow-lg flex items-center justify-center
                   transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white"
        style={{
      ...
      >
        ...
        <svg width="26" height="26" viewBox="0 0 32 32" fill="#FFFFFF" aria-hidden="true">
          <path d="M19.11 17.76c-.29-.14-1.68-.83-1.94-.93-.26-.1-.45-.14-.64.14-.19.29-.73.93-.9 1.12-.17.19-.33.22-.62.07-1.68-.83-2.77-1.49-3.88-3.38-.29-.5.29-.46.83-1.53.09-.19.04-.36-.02-.5-.07-.14-.64-1.54-.88-2.1-.23-.56-.47-.48-.64-.49h-.55c-.19 0-.5.07-.76.36-.26.29-1 1-1 2.43s1.02 2.82 1.16 3.02c.14.19 2 3.04 4.84 4.27.68.29 1.2.46 1.61.59.68.22 1.3.19 1.79.12.55-.08 1.68-.69 1.92-1.36.24-.67.24-1.24.17-1.36-.07-.12-.26-.19-.55-.33z"/><path d="M26.07 5.93A10.94 10.94 0 0016 2a10.94 10.94 0 00-9.93 16.01L4 30l12.18-2.02A10.96 10.96 0 0016 28a10.94 10.94 0 0010.07-16.07zm-10.07 19.6a8.63 8.63 0 01-4.4-1.2l-.32-.19-7.28 1.21 1.24-7.11-.21-.33A8.63 8.63 0 1116 25.53z"/>
        </svg>
      </button>
      ...
      {open && (
        <div
          className="mt-3 w-[88vw] max-w-[360px] rounded-2xl overflow-hidden shadow-2xl
