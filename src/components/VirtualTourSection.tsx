      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-primary mb-4">Tour Virtual</h2>
          ...
          {/* Virtual Tour Player */}
          <div className="mb-16">
            <div className="relative section-primary-bg rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-foreground/80">Use as setas para navegar</span>
                </div>
              </div>
            </div>
          </div>
