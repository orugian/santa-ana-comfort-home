  ...
  return (
    <section className="relative isolate w-full min-h-screen flex items-center justify-center">
      ...
      <div aria-hidden className="absolute inset-0 -z-10">
        ...
        <div aria-hidden className="absolute inset-0 -z-0 bg-gradient-to-b from-white/40 via-white/20 to-transparent"></div>
      </div>
...
<div className="mx-auto mt-3 h-1.5 w-72 sm:w-[26rem] md:w-[32rem] rounded-full bg-gradient-to-r from-primary via-emerald-400 to-primary opacity-90"></div>
            ...
            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-slate-800/90 bg-white/60 md:bg-white/50 backdrop-blur-md rounded-xl px-4 py-2 ring-1 ring-white/60 shadow-sm font-semibold">
