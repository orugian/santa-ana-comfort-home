        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/lar_santa_ana/" target="_blank" rel="noopener noreferrer" className="text-foreground/60 hover:text-custom-pink transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+551125372024" className="text-foreground/80 hover:text-primary transition-colors">(11) 2537-2024</a>
              </div>
              <div className="flex items-center space-x-3">
