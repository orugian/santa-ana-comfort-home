        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-accent-light p-8 rounded-lg shadow-sm">
              <h3 className="text-2xl text-foreground mb-4 text-center font-bold">Missão</h3>
            ...
            <div className="bg-accent-light p-8 rounded-lg shadow-sm">
              <h3 className="text-2xl text-foreground mb-4 text-center font-bold">Visão</h3>
            ...
            <div className="bg-accent-light p-8 rounded-lg shadow-sm">
              <h3 className="text-2xl text-foreground mb-4 text-center font-bold">Valores</h3>
